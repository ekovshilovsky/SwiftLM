...
public struct TurboQuantModelLoader {
    ...
    public static func isTurboQuantModel(at path: String) -> Bool {
    ...
    public static func load(from path: String) -> TurboQuantModel? {
    ...
    public static func validateMetadata(at path: String) -> String? {
        let configURL = URL(fileURLWithPath: path)
            .appendingPathComponent("config.json")
    ...
    public static func readModelConfig(at path: String) -> ModelParams? {
        let configURL = URL(fileURLWithPath: path)
            .appendingPathComponent("config.json")
    ...
    public struct ModelParams {
        ...
        public let estimatedParameterCount: UInt64
    }
}
